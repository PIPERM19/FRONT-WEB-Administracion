...
const tierStyles: Record<string, { ring: string; badgeBg: string; label: string }> = {
  platinum: { ring: "ring-2 ring-blue-300", badgeBg: "bg-gradient-to-br from-white via-blue-200 to-blue-400", label: "Platinum" },
...
export function MainLayout({
  ...
  return (
    <div className="flex min-h-screen flex-col bg-white text-black">
      {/* HEADER MODIFICADO: Borde azul y sombra */}
      <header 
